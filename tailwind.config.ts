  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'move-circle-1': 'move-circle-1 4s ease-in-out infinite',
        'move-circle-2': 'move-circle-2 5s ease-in-out infinite',
        'move-circle-3': 'move-circle-3 6s ease-in-out infinite',
        'move-circle-4': 'move-circle-4 5.5s ease-in-out infinite',
        'move-circle-5': 'move-circle-5 4.5s ease-in-out infinite',
